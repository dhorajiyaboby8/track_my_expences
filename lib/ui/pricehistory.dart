...
var symbol=SharedPrefrencesHelper.getcurrency();
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text(
                                  expenseList[index].itemname.toString(),
                                  style: TextStyle(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                // Text(
                                //   'Difference :${statusindicator(expenseList[index].itemprice,itemList[index].itemprice)}',
                                //   style: TextStyle(fontSize: 15),
                                // ),
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '\u{20B9}${expenseList[index].itemtotalprice}',
                                      style: TextStyle(fontSize: 15),
                                    )
                                  ],
                                ),
  ...
  statusindicator(date,data) {

    var itemprice = int.parse(date);
    var newitemprice = int.parse(data);
    var difference = newitemprice - itemprice;
    return difference;
  }
